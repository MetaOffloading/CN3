...
public class SessionInfo {
	...
	public static String[] counterbalanceFactors = {"whichReminderFirst", "whichRewardFirst", "revealableClock"};
	public static int[] counterbalanceLevels = {2, 2, 2};
	public static int[] specifiedLevels = {-1, -1, ExtraNames.REVEALABLE};
